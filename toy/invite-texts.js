/* ============================================================================
   Toʻy-Daftar · тексты приглашений и сообщений организатора
   ----------------------------------------------------------------------------
...
const OCCASIONS = [
  ...
  { id:"nikoh_toy", theme:"zar",
    ...
    label:{ uz_latin:"Nikoh toʻy", uz_cyrillic:"Никоҳ тўй", ru:"Свадьба" },
    greeting:{
      uz_latin:"Hurmatli mehmon! Farzandlarimiz hayotidagi eng quvonchli kun — nikoh toʻyi marosimiga Sizni va oilangizni taklif etamiz. Shodiyonamizda Sizdek aziz insonlarning boʻlishi biz uchun katta sharaf. Tashrifingizdan mamnun boʻlamiz.",
    ...
    share:{
      first:{
        uz_latin:"Assalomu alaykum! {{date}} kuni farzandlarimizning toʻyi boʻladi — Sizni va oilangizni chin dildan taklif qilamiz. Havolani ochib, nechta mehmon kelishingizni belgilab qoʻysangiz, zalga aniq sonni oldindan aytamiz.",
      ...
      remind:{
        uz_latin:"Assalomu alaykum! Toʻyimizga sanoqli kun qoldi, javobingizni hali olmadik. Iltimos, havolani ochib nechta kishi kelishingizni belgilang — roʻyxatni shu hafta zalga topshiramiz.",
      ...
      moved:{
        uz_latin:"Assalomu alaykum! Toʻy sanasi oʻzgardi: yangi sana — {{date}}, joy oʻzgarmadi, {{venue}}. Eski havola ishlayapti — javobingizni yangi sanaga qarab yangilab qoʻying, iltimos.",
      ...
      thanks:{
        uz_latin:"Hurmatli mehmon, toʻyimizga tashrif buyurganingiz uchun katta rahmat! Iliq tilaklaringiz oilamiz uchun juda qadrli boʻldi. Sizning xonadoningizda ham shunday shodiyonali kunlar koʻp boʻlsin.",
  ...
  { id:"fotiha", theme:"oq",
    ...
    label:{ uz_latin:"Fotiha toʻy", uz_cyrillic:"Фотиҳа тўй", ru:"Фотиха-туй" },
    greeting:{
      uz_latin:"Hurmatli mehmon! Qizimizni oq yoʻl tilab uzatish — fotiha toʻyi marosimiga Sizni va oilangizni taklif etamiz. Shu qutlug' kunda kattalarimizning oq fotihasi va ezgu tilaklari biz uchun eng qimmatli sovgʻa. Fayzli dasturxonimizdan joy olsangiz, baxtiyor boʻlamiz.",
    ...
    share:{
      first:{
        uz_latin:"Assalomu alaykum! {{date}} kuni qizimizning fotiha toʻyi — Sizni va oilangizni taklif etamiz. Havolani ochib, nechta mehmon kelishingizni belgilab qoʻying: dasturxonni shunga qarab tayyorlaymiz.",
      ...
      remind:{
        uz_latin:"Assalomu alaykum! Fotiha toʻyiga oz qoldi, javobingizni kutyapmiz. Havolada bir marta bosib qoʻysangiz kifoya — nechta kishi kelishingizni bilsak, joyni oldindan tayyorlaymiz.",
      ...
      moved:{
        uz_latin:"Assalomu alaykum! Fotiha toʻyi sanasi koʻchdi: yangi sana — {{date}}, boshlanish vaqti {{time}}. Eski havola ishlayapti — javobingizni yangilab qoʻying, iltimos.",
      ...
      thanks:{
        uz_latin:"Qizimizning fotiha toʻyida biz bilan birga boʻlganingiz uchun rahmat! Oq fotihangiz va ezgu tilaklaringiz yodimizda qoladi. Sizning oilangizda ham shunday quvonchli kunlar koʻp boʻlsin.",
  ...
  { id:"beshik_toy", theme:"atlas",
    ...
    label:{ uz_latin:"Beshik toʻy", uz_cyrillic:"Бешик тўй", ru:"Бешик-той" },
    greeting:{
      uz_latin:"Assalomu alaykum, hurmatli mehmon! Xonadonimizga quvonch kirib keldi — farzandimizning beshik toʻyiga Sizni va oilangizni chin dildan taklif etamiz. Chaqalogʻimizga aytilgan ezgu tilaklaringiz biz uchun juda qadrli. Samimiy davramizda koʻrishaylik.",
    ...
    share:{
      first:{
        uz_latin:"Suyunchi! Xonadonimizda chaqaloq dunyoga keldi. {{date}} kuni beshik toʻyi qilyapmiz — havolani ochib, oilangizdan nechta mehmon kelishini belgilab qoʻying.",
      ...
      remind:{
        uz_latin:"Assalomu alaykum! Beshik toʻyimizga kam qoldi, Sizdan javob yoʻq. Kelasizmi yoki yoʻqmi — havolada belgilab qoʻysangiz, mehmonlar sonini aniq bilamiz.",
      ...
      moved:{
        uz_latin:"Assalomu alaykum! Beshik toʻyini boshqa kunga surdik: yangi sana — {{date}}, vaqti {{time}}. Havola oʻsha-oʻsha — javobingizni yangilab qoʻying.",
      ...
      thanks:{
        uz_latin:"Beshik toʻyimizga kelib, chaqalogʻimizga ezgu tilaklar aytganingiz uchun rahmat! Uyimiz Siz bilan yanada fayzli boʻldi. Farzandlaringiz doim sog'-salomat boʻlsin.",
  ...
  { id:"sunnat_toy", theme:"atlas",
    ...
    label:{ uz_latin:"Sunnat toʻy", uz_cyrillic:"Суннат тўй", ru:"Суннат-той" },
    greeting:{
      uz_latin:"Hurmatli mehmon! Oʻgʻlimizning sunnat toʻyi munosabati bilan Sizni va oilangizni davramizga taklif etamiz. Bu kun oilamiz uchun katta quvonch — uni yaqin insonlar bilan birga nishonlamoqchimiz. Kelib, farzandimizga oq yoʻl tilab ketsangiz, minnatdor boʻlamiz.",
    ...
    share:{
      first:{
        uz_latin:"Assalomu alaykum! {{date}} kuni oʻgʻlimizning sunnat toʻyi — Sizni va oilangizni kutamiz. Havolani ochib, nechta kishi kelishingizni belgilab qoʻying: zalga sonni oldindan aytishimiz kerak.",
      ...
      remind:{
        uz_latin:"Assalomu alaykum! Sunnat toʻyimizga sanoqli kun qoldi, javobingiz hali yoʻq. Iltimos, havolada nechta mehmon kelishingizni belgilang — joy va oshni shunga qarab hisoblaymiz.",
      ...
      moved:{
        uz_latin:"Assalomu alaykum! Sunnat toʻyi sanasi oʻzgardi — yangi sana {{date}}, joy oʻzgarmadi: {{venue}}. Havola ishlayapti, javobingizni qaytadan belgilab qoʻying.",
      ...
      thanks:{
        uz_latin:"Sunnat toʻyimizga tashrif buyurganingiz uchun katta rahmat! Oʻgʻlimizga aytgan ezgu tilaklaringiz biz uchun juda qadrli. Sizning xonadoningizda ham shodiyonalar koʻp boʻlsin.",
  ...
  { id:"yubiley", theme:"kecha",
    ...
    greeting:{
      uz_latin:"Hurmatli mehmon! Oilamiz uchun aziz insonning tavallud ayyomi — yubiley tantanasiga Sizni va oilangizni taklif etamiz. Yillar davomida yonimizda boʻlgan insonlar bilan bu kunni birga nishonlash biz uchun alohida qadrli. Iliq soʻzlaringiz va tashrifingizni intiqlik bilan kutamiz.",
    ...
    share:{
      first:{
        uz_latin:"Assalomu alaykum! {{date}} kuni {{names}} yubileyini nishonlaymiz, Sizni va oilangizni taklif etamiz. Havolani ochib nechta kishi kelishingizni belgilab qoʻysangiz, joyni oldindan tayyorlab qoʻyamiz.",
      ...
      remind:{
        uz_latin:"Assalomu alaykum! Tantanaga oz qoldi, javobingizni hali olmadik. Iltimos, havolada kelasizmi-yoʻqmi belgilab qoʻying — stol va joylarni shunga qarab tayyorlaymiz.",
      ...
      moved:{
        uz_latin:"Assalomu alaykum! Yubiley kechasi boshqa kunga koʻchdi: {{date}}, soat {{time}}. Havola oʻzgarmadi — javobingizni yangi sanaga moslab belgilab qoʻying.",
      ...
      thanks:{
        uz_latin:"Yubiley kechamizga kelib, iliq soʻzlaringizni ayamaganingiz uchun rahmat! Shunday insonlar davrasida boʻlish oilamiz uchun katta baxt. Oʻzingizga uzoq umr va sogʻlik tilaymiz.",
  ...
  { id:"nahor_osh", theme:"oq",
    ...
    share:{
      first:{
        uz_latin:"Assalomu alaykum! {{date}} kuni ertalab nahor oshi beramiz, {{venue}}. Osh soat {{time}} da tortiladi — havolada kelishingizni belgilab qoʻying.",
      ...
      remind:{
        uz_latin:"Assalomu alaykum! Nahor oshiga oz qoldi, javobingiz yoʻq. Havolada belgilab qoʻying, iltimos — osh {{time}} da tortiladi, kechikmang.",
      ...
      moved:{
        uz_latin:"Assalomu alaykum! Nahor oshi boshqa kunga koʻchdi: {{date}}, soat {{time}}, joy oʻzgarmadi — {{venue}}. Havolada javobingizni yangilab qoʻying.",
      ...
      thanks:{
        uz_latin:"Ertalabki oshimizga kelganingiz uchun rahmat! Erta turib tashrif buyurdingiz — buni unutmaymiz. Xonadoningizda doim toʻkin dasturxon boʻlsin.",
