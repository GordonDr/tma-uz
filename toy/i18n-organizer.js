...
const T_ORG = {
  ru: {
    ...
    mSeatHint:"Поставьте свою — тойхоны считают по-разному. Сумма пересчитается сразу.",
  ...
  uz: {
    ...
    mSeatHint:"O'zingiznikini qo'ying — to'yxonalar har xil hisoblaydi. Summa darrov qayta hisoblanadi.",
