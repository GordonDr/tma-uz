...
const T_ORG = {
  ru: {
    ...
    pInvNote:"Одна картинка вместо ссылки — для тех, у кого нет телеграма. Пересылается в WhatsApp и печатается: размер A5.",
  ...
  uz: {
    ...
    pInvNote:"Havola o'rniga bitta rasm — telegrami yo'qlar uchun. WhatsApp orqali yuboriladi va chop etiladi: o'lchami A5.",
